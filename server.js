...
// CONFIGURAÇÃO DO POOL OTIMIZADA PARA RESOLVER ENETUNREACH E TIMEOUTS NO RENDER
const pool = new Pool({
  connectionString: databaseUrl,
  ssl: databaseSsl ? { rejectUnauthorized: false } : undefined,
  // Trava de segurança para evitar que conexões travadas em IPv6 derrubem o servidor
...
// Executa a criação das tabelas de forma assíncrona segura
initDatabase();
...
async function getBootstrap() {
  ...
  try {
    ...
    try {
      ...
      // Sem dados suficientes para o KPI, segue em frente de forma limpa
    }

    // Mapeamento idêntico ao esperado pelo frontend estruturado
    return {
...
// Tratamento de edições de itens existentes vindas da rota PUT
